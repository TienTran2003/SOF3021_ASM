	...
	<section class="hero">
		<div class="hero__slider owl-carousel">
			<div class="hero__items set-bg"
				data-setbg="/user/img/hero/hero-1.jpg">
				<div class="container">
					<div class="row">
			...
			<div class="hero__items set-bg"
				data-setbg="/user/img/hero/hero-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-5 col-lg-7 col-md-8">
							<div class="hero__text">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<ul class="filter__controls">
						<li class="active" data-filter="*">All Fashion</li>
						<li data-filter=".Nam">Men Fashion</li>
						<li data-filter=".Nu">Women Fashion</li>
					</ul>
				</div>
			</div>
			<div class="row product__filter">
				<c:forEach var="item" items="${page.content}">
					<div
						class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix ${item.category.name}">
			...
			<div class="text-center button">
				<a href="/home?p=0" class="btn btn-primary">First</a> <a
					href="/home?p=${page.number-1}" class="btn btn-primary">Previous</a>
				<a href="/home?p=${page.number+1}" class="btn btn-primary">Next</a>
				<a href="/home?p=${page.totalPages-1}" class="btn btn-primary">Last</a>
			</div>
		</div>
	</section>
	<!-- Product Section End -->
				...
				<div class="col-lg-8">
					<div class="instagram__pic">
						<div class="instagram__pic__item set-bg"
							data-setbg="/user/img/instagram/instagram-1.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="/user/img/instagram/instagram-2.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="/user/img/instagram/instagram-3.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="/user/img/instagram/instagram-4.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="/user/img/instagram/instagram-5.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="/user/img/instagram/instagram-6.jpg"></div>
					</div>
				</div>
				<div class="col-lg-4">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg"
							data-setbg="/user/img/blog/blog-1.jpg"></div>
						<div class="blog__item__text">
							<span><img src="/user/img/icon/calendar.png" alt="">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg"
							data-setbg="/user/img/blog/blog-2.jpg"></div>
						<div class="blog__item__text">
							<span><img src="/user/img/icon/calendar.png" alt="">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg"
							data-setbg="/user/img/blog/blog-3.jpg"></div>
						<div class="blog__item__text">
							<span><img src="/user/img/icon/calendar.png" alt="">
