		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="row">
						<c:forEach var="item" items="${wmList.content}">
									...
									<div class="product__item__pic set-bg"
										...
										<ul class="product__hover">
											<li><a href="#"><img src="/user/img/icon/heart.png"
													alt=""></a></li>
											<li><a href="#"><img
													src="/user/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
					...
					<div class="text-center button">
						<a href="/shop/women?p=0" class="btn btn-primary">First</a> <a
							href="/shop/women?p=${page.number-1}" class="btn btn-primary">Previous</a>
						<a href="/shop/women?p=${page.number+1}" class="btn btn-primary">Next</a>
						<a href="/shop/women?p=${page.totalPages-1}"
