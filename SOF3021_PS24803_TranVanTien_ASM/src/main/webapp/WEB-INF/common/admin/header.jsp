...
<div id="wrapper">
	...
	<div id="sidebar-wrapper" data-simplebar=""
		...
		<div class="brand-logo">
			<a href="/home"> <img src="/admin/images/logo-icon.png"
				class="logo-icon" alt="logo icon">
				<h5 class="logo-text">TienTran Admin</h5>
			</a>
		</div>
		<ul class="sidebar-menu do-nicescrol">
			<li class="sidebar-header">MAIN NAVIGATION</li>
			<li><a href="/home/admin"> <i
					class="zmdi zmdi-view-dashboard"></i> <span>Product</span>
			</a></li>

			<li><a href="/admin/product"> <i
					class="zmdi zmdi-invert-colors"></i> <span>Edit Product</span>
			</a></li>

			<li><a href="/admin/account"> <i
					class="zmdi zmdi-format-list-bulleted"></i> <span>Account</span>
			</a></li>

			<li><a href="/admin/accountManage"> <i
					class="zmdi zmdi-grid"></i> <span>Account Manager</span>
			</a></li>

			<li><a href="/admin/order"> <i class="zmdi zmdi-grid"></i> <span>Order
						Manager</span>
			</a></li>
